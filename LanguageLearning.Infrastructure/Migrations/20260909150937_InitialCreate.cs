        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PortugueseText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommonSentences", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PortugueseWord = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Type = table.Column<int>(type: "int", nullable: false),
                    PortugueseGender = table.Column<int>(type: "int", nullable: false),
                    EnglishAudioUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PersianAudioUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PortugueseAudioUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
